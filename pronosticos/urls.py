...
from .views import crear_semana, dashboard, detalle_semana, historial, mostrar_ultima_semana, ver_semana_actual
...
urlpatterns = [
    ...
    path('crear-semana/', crear_semana, name='crear_semana')
]
